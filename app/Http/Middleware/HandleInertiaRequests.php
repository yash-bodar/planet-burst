...
class HandleInertiaRequests extends Middleware
{
     ...
     *
     * // YB - 15-09-2026 Asset versioning for Inertia
     *
     ...
     *
     * // YB - 15-09-2026 Define default shared props for Inertia frontend
     *
        ...
        return [
            ...
            'auth' => [
                ...
                'user' => $request->user() ? [
                    ...
                    'games_won' => $request->user()->games_won,
                    'current_streak' => $request->user()->current_streak,
                    'max_streak' => $request->user()->max_streak,
                ] : null,
            ],
            'flash' => [
